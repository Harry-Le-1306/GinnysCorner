<?php
    define("TITLE", "Contact Us | Ginner's Corner");
    ...
    <div id="contact">
            ...
            <?php
                ...
                if(isset($_POST['contact_submit'])) {
                    ...
                    if (isset($_POST['subscribe']) && $_POST['subscribe'] == 'Subcribe') {
            ...
            <h5>Thanks for contacting Ginny's!</h5>
            <p>Please allow 24 hours for our response.</p>
