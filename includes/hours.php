...
<html lang="en" xml:lang="en"><head>
    ...
    $hours = array(
        ...
        'fri' => array('13:00-23:00'), // Open late
        'sat' => array('13:00-23:00'),
        'sun' => array('')  // Closed
    );
    ...
    $exceptions = array(
        '12/25'  => array('13:00-17:00'),
        '1/1' => array('13:00-17:00')
    );
    ...
    if($store_hours->is_open()) {
        echo ("<p style=\"color:#108A25\";><strong>Yes, we're open! Today's hours are " . $store_hours->hours_today() . ".</strong></p>");
    } else {
        echo ("<p style=\"color:#FF0000\";><strong>Sorry, we're closed.</strong></p>");
    }
